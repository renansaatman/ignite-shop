...
export default function Success({customerName, productsImages}: SuccessProps) {
  ...
  return (
    <>
      ...
      <SuccessContainer>
        <ImagesContainer>
          {productsImages && productsImages.map((image, index) => {
            return (
        ...
        <p>
          Uhuul <strong>{customerName}</strong>, sua compra de {`${productsImages.length} ${productsImages.length > 1 ? 'camisetas' : 'camiseta'}`}  já está a caminho da sua casa. 
        </p>
